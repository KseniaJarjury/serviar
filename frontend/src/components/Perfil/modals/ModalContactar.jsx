...
function ModalContactar({
  showModalContactar,
  setShowModalContactar,
  usuario,
  localidad,
  provincia,
  servicio,
  ...
  const handleEnviarClick = () => {
    // Realiza aquí la lógica para enviar el formulario, si es necesario.
    // ...
                  ...
                  <div className="relative my-8 mx-[16rem] w-[70vh] md:w-[90vh]">
                    <div className="rounded-lg  relative flex flex-col md:flex-row md:max-h-[100rem] bg-white outline-none focus:outline-none">
                      ...
                      <div className="flex flex-col md:w-[90vh] md:max-h-[70rem] text-black md:gap-6 fondoFormulario">
                        <div>
                          <h1 className="text-2xl md:text-4xl font-bold mt-14 ml-12">
                            {usuario && usuario.NombreApellido}
                          </h1>
                          <p className="ml-12 text-[22px]">
                        ...
                        <div className="flex items-center ml-6 p-4">
                          ...
                          <p className="text-white w-52 md:text-[18px] text-xs">
                            {usuario ? usuario.Telefono : "Telefono no disponible"}
                          </p>
                        </div>
                        <div className="flex items-center ml-6 p-4">
                          <img src={email} alt="mail" className="w-6 mb-1 mr-3" />
                          <p className="text-white w-52 md:text-[18px] text-xs">
                            {usuario ? usuario.email : "Correo no disponible"}
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        <h1 className="text-[#001A29] text-2xl md:text-[2.4rem] mb-2 -mt-3 font-bold">
                          Contactanos
                        </h1>
                        {/* nombre  */}
                        <div className="flex flex-col text-lg mt-5">
                          <label htmlFor="nombre" className="text-[#666666]">
                            Nombre
                          </label>
                          <input
                            id="nombre"
                            className="w-52 bordes text-lg text-[#03ABE6] p-1"
                            type="text"
                            required
                          />
                        </div>
                        ...
                        <div className="flex flex-col mt-5">
                          <label htmlFor="correo" className="text-[#666666] text-lg">
                            Correo
                          </label>
                          <input
                            id="correo"
                        ...
                        {/* mensaje  */}
                        <div className="flex flex-col mt-5">
                          <label htmlFor="mensaje" className="text-[#666666] text-lg">
                            Mensaje
                          </label>
                          <textarea
                            name=""
                            id="mensaje"
                            className="w-72 h-16 bordes text-lg text-[#03ABE6] p-1 resize-none"
                            type="text"
                            cols="10"
                            rows="10"
                            required
