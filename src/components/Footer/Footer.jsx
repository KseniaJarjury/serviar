...
function Footer() {
  ...
  return (
    ...
    <div className='bg-[#001A29]'>
      <div className='footer w-full h-500 flex flex-row gap-2 px-6 py-2'>
      ...
      <p className='text-white text-center font-bold w-full m-auto mt-12 text-base md:text-lg lg:text-xl'>©2023 Serviar. Conocé los términos de uso y nuestra política de privacidad.</p>
    </div>
    </>
  );
}
